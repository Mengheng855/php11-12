    ...
    <div class="container w-50 mt-4 p-5 shadow rounded-2">
        ...
        <form action="update.php" method="post">
            ...
            <div class="mb-2">
                ...
                <input type="number" name="salary" value="<?= $row['salary'] ?>" class="form-control" placeholder="salary...">
            </div>
            <button name="update" type="submit" class="btn btn-warning d-flex mx-auto">Update</button>
        </form>
    </div>
</body>
